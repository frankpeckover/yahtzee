...
createStar(document.getElementById('starHolder'));

function createStar(starHolder) {
	...
	star.style.boxShadow = `${size}px ${size}px ${size}px ${size}px #ffffff`;
